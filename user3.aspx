<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user3.aspx.cs" Inherits="standard.user3" %>
        ...
        <div id="show" align="center" style="width: auto; height: 84%; top: auto">
            ...
            <div style="height: 97%">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    DataKeyNames="number" BackColor="White" BorderColor="#CCCCCC" 
                    BorderStyle="None" BorderWidth="1px" CellPadding="3" Height="391px" 
                    Width="821px" >
                    <Columns>
                        ...
                        <asp:ButtonField ButtonType="Button" CommandName="yes" HeaderText="操作" 
                            ShowHeader="True" Text="允许公示" />
                        <asp:ButtonField ButtonType="Button" CommandName="no" HeaderText="操作" 
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    <SelectParameters>
                        <asp:Parameter DefaultValue="3" Name="类型" Type="Int32" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </div>
        </div>
